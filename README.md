...
- Ежедневное уведомление-сводка около 17:00 МСК (WorkManager): по строке на
  валюту, «1 EUR = 90.50 RUB» (курс к основной).
- Сводка по запросу: кнопка «🔔 Сводка курсов» на экране конвертации — те же
  курсы избранных валют к основной, не дожидаясь уведомления.
